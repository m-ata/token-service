...
*/
export const getUserByField = async (field: string, value: string | number): Promise<any> => {
...
*/
export const updateUser = async function (opts: IUser): Promise<any> {
  console.debug(
...
*/
export const getToken = async (jti: string): Promise<any> => {
...
*/
export const insertToken = async (token: any): Promise<any> => {
...
*/
export const deleteToken = async (jti: string): Promise<any> => {
...
*/
export const cleanupTokens = async function (): Promise<any> {
...
/*
  tokens
*/
export const getTokenByJti = async function (jti: string): Promise<any> {
  console.debug('MongoDB.getToken()')
  const res = await fishRegDb.collection('token-service').find({ jti }).toArray()
  if (res?.length) return res[0]
}
